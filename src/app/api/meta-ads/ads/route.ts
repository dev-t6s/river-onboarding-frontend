...
import { ApiDataResponse, AdData } from "@/types/meta-ads";
import * as bizSdk from "facebook-nodejs-business-sdk";

export async function GET(
  request: NextRequest
): Promise<NextResponse<ApiDataResponse<AdData[]>>> {
  try {
    ...
    const adsData = await metaAdsService.getAdsData(
      account,
      timeRange,
      campaignId
    );
