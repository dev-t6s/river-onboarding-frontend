...
interface AuditDataResponse {
  error:string;
  status: string;
  accountId: string;
    auditResults: {
      getAdAccounts_result: any[];
      getAdvancedData_result: any;
      getTotalMetrics_result: any;
      getCampaignData_result: any[];
      getAdsetData_result: any[];
      getAdsData_result: any[];
      getPlatformSpendSalesData_result: any;
      getPlacementSpendSales_result: any;
      getPlacementDeviceData_result: any;
  };
  updatedAt: string;
}
...
export async function generateMetadata({
  ...
  return {
    title: `Ads Dashboard - ${jobId}`,
  };
}

async function fetchAuditData(jobId: string): Promise<AuditDataResponse | null> {
  try {
...
export default async function DashboardPage({ 
  ...
  const { jobId } = await params;
  const data = await fetchAuditData(jobId);
  ...
  const {
    ...
    auditResults: {
      ...
      getTotalMetrics_result: totalMetricsData,
      getCampaignData_result: campaignData,
      getAdsetData_result: adSetData,
      getAdsData_result: adsData,
      getPlatformSpendSalesData_result: platormSpendData,
      getPlacementSpendSales_result: placementSpendData,
      getPlacementDeviceData_result: placementDeviceData,
    },
    updatedAt: updatedAt
  } = data;
