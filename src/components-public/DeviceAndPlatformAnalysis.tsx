...
interface AudienceAnalysisProps {
  ...
  sortBy: string;
  sortOrder: string;
  platformSpendSalesData: PlatformSpendSalesType,
  placementSpendSalesData: PlacementSpentSalesType,
  placementDeviceData: PlacementDeviceType,
}
...
export const DeviceAndPlatformAnalysis = ({
	...
	sortBy,
	sortOrder,
  platformSpendSalesData,
  placementSpendSalesData,
  placementDeviceData,
  ...
  const PlatformDeviceTooltip = ({ active, payload, label }: any) => {
	...
	return(
        ...
        <div className="fixed inset-0 bg-opacity-50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl p-9 w-full max-w-6xl max-h-[90vh] overflow-auto ring-neutral-200 ring-1">
